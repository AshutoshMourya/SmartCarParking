...
<body>
  ...
  <table align="center">
    <tr>
        <td><a href="cs.jsp" class="button">CS Department Parking </a> </td>
        <td><a href="lt.jsp" class="button">LT Parking </a> </td>
    </tr>
    <tr>
        <td><a href="parkarea.jsp" class="button">Main Parking </a> </td>
        <td><a href="ac.jsp" class="button">Activity Center Parking </a> </td>
    </tr>
</table>
    <br>
    <h2>Need Space? </h2>
  ...
  <div class="main" id="Section">
    ...
    <div class="part">
      ...
      <ul>
        ...
        <li>Many of our car parks are linked via a helpline to our 24/7 national operations centre</li>
